...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Titolo","1. AcaGreen","2. Registrazione e Login","3 Profilo","4. Attività","5. Inventario","6. Sensori e robot","7. Risorse Umane","Preparazione","Semina","Concima","Irrigazione"],
    DREX_NODE_LINKS: ["index.htm","acagreen.htm","registrazione_e_login.htm","3_profilo.htm","4__attivita.htm","5__inventario.htm","6__sensori_e_robot.htm","7__risorse_umane.htm","preparazione.htm","semina.htm","concima.htm","irrigazione.htm"],
    DREX_NODE_CHILD_START: [1,8,8,8,8,12,12,12,12,12,12,12],
    DREX_NODE_CHILD_END: [8,8,8,8,12,12,12,12,12,12,12,12],
    DREX_MENU_TYPE: 2,
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_PREVIEW_MODE_SEARCH_IS_DISABLED_NOTICE : "Ricerca disabilita in modalit&#x00E0; anteprima",
    DREXPLAIN_ERROR_LOCAL_SEARCH : "Impossibile scaricare i file degli indici di ricerca. Si prega di caricare i file HTML su un server web e di accedervi tramite URL che iniziano con https:// oppure http:// .",
    DREXPLAIN_ERROR_REMOTE_SEARCH : "Impossibile scaricare i file degli indici di ricerca. Chiedere all\'amministratore del proprio server web di abilitare il download di file con estensione .json o contattare help@drexplain.com. Codice di errore: {0}"
