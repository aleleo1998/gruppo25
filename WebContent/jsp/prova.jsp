  ...
  <p id="id<%=i%>" style="display:none"><%=utente.getId()%></p>
    ...
    <div class="col-sm" id="libero<%=i%>"><strong style="font-size: 0.8em;">Stato</strong>
    	<img src="../img/riposo.png" style="width: 30px; height: 30px;">	
    		...
    		<button type="button" style="margin-top:3em; font-size:0.6em; width: 125px;" class="buttonAssegna" name="<%=i%>" data-toggle="modal" data-target="#modalRelatedContent" id="libero<%=i%>">Assegna lavoro</button>
    ...
    <div style="display:none" id="occupato<%=i%>" class="col-sm"><strong style="font-size: 0.8em;">Stato</strong>
    	...
    	<input type="text" value="<%=utente.getId()%>" style="display:none"></input>
    		<button style="margin-top:3em; font-size:0.6em; width: 125px;" class="buttonAnnulla" name="<%=i%>" data-toggle="modal" data-target="#modalRelatedContent" id="occupato<%=i%>">Annulla lavoro</button>
			<!--Modal: modalRelatedContent-->
					  ...
					  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-info" role="document">
					    ...
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					        ...
					        <!-- FINE PRIMA RIGA -->
					        	<button class="myButton2" id="<%=i%>" style="margin-right: 2em">Conferma</button>
					            <button type="button" id="annulla" class="myButton">Annulla</button>
