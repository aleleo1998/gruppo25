...
<link rel="stylesheet" href="../css/pesticida.css">
...
<div id="container">
	...
	<div id="avviso">
	<center><span> E' stato rilevato un problema relativo alla presenza di parassiti. </span></center>
	<center><span> Procedi ad effettuar ela sanificazione con il pesticida consigliato. </span>  </center>
	<center><i class="fas fa-exclamation-circle"></i></center>
	...
	<div id="form-box" class="card">
	  <div class="card-header">
	    Seleziona Pesticida <p style = "text-decoration:line-through;"> </p>
	  </div>
	  <div class="card-body">
...
<form action="../seminaServlet" name="formSemina" id="formSemina">
  ...
  %>
    <% for(Inventario inv : inventarioList){ %> 
    	<%if(inv.getTipo().equals("pesticida")){ 
  	...
  	<div id="row" class="rowInventario">
	    ...
	    <div class="media mb-4">
			...
			<input form="formSemina" id="radio" type="radio" name="colture" value="<%=inv.getIdItem()%>">  
	      	...
	      	<img class="rounded" src="../img/pesticida.jpg" alt="Generic placeholder image">
